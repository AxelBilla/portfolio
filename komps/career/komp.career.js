            ...
            "load", (self)=>{
                let setValue = ()=>{
                    ...
                    for(let i = 0; i<titles.length; i++){
                        ...
                        el_content.setAttribute("as", "career_content");
...
careers.push(new Career("BTS Systèmes Informatiques aux Entreprises\nOption SLAM", "Lycée Paris Turgot", 2024, 2026,
    {
        titles: {
...
careers.push(new Career("Stage Développement Unity C# (1/2)", "MONGAME", 2025, 2025,
    {
        titles: {
        },
        paragraphs: {
...
careers.push(new Career("Stage Développement Unity C# (2/2)", "MONGAME", 2025, 2026,
    {
        titles: {
        },
        paragraphs: {
